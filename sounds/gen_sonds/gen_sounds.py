...
def save_tts_google(word, filename, language_code="fr-FR", target_length=1):
    ...
    if target_length:
        ...
        speaking_rate = min(builtins.max(initial_duration / target_length, 0.75), 1.25)
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\Users\sianna.groesser\Downloads\imagegen-473314-63d1e2397915.json"

words = [
    "ancre", "fourmi", "cheval", "bus", "visage", "banane", "lunettes", "panier", "lait", "ceinture", "vélo"
]


output_dir = r"C:\sync_folder\TSRlearn-task\sounds"
language_code = "fr-FR"
target_length = 1.0  # seconds
...
for word in tqdm(words):
    filename = os.path.join(output_dir, f"{word}_fr.mp3")

    duration, speaking_rate = save_tts_google(
        word=word,
        filename=filename,
        language_code=language_code,
